...
const hospitalityPainCards: IndustryPainCard[] = [
  {
    title: "Lost reservations",
    text: "Bookings disappear when enquiries are not answered, confirmed, or followed up fast enough.",
    badge: "Lost revenue",
    icon: CalendarCheck,
    isPrimary: true,
    className:
  ...
  },
  {
    ...
    text: "Guests call during busy hours and leave when no one answers.",
  ...
  },
  {
    ...
    text: "Customers ask about rooms, tables, menus, or packages and move on when replies are slow.",
    badge: "Slow response",
    icon: MessageCircle,
    className:
  ...
  {
    title: "Repeated menu and room questions",
    text: "Staff keep answering the same questions about availability, prices, menus, location, and opening hours.",
    badge: "Staff overload",
    icon: ClipboardList,
    className:
...
const hospitalityUseCases: IndustryUseCase[] = [
  {
    title: "Table reservations",
    description: "Collects guest count, date, time, and contact details.",
    icon: CalendarCheck,
    mode: "Voice or chat",
    customer: "Hi, do you have a table for 4 tonight?",
    ai: "Yes, I can help check availability. Please share your preferred time and I will note the reservation request.",
    followUp: "Reservation request saved with guest count, time, and contact details.",
    visualLabel: "Table reservation preview",
  },
  {
    title: "Room availability",
    description: "Captures dates, guests, room preference, and next steps.",
    icon: Home,
    mode: "Chat support",
    customer: "Do you have rooms available this weekend?",
    ai: "I can help with that. I will collect your dates, number of guests, and room preference.",
    followUp: "Room enquiry summary sent to the dashboard.",
    visualLabel: "Room availability preview",
  },
  {
    title: "Menu questions",
    description: "Answers approved menu, dietary, and availability questions.",
    icon: ClipboardList,
    mode: "Menu assistant",
    customer: "Do you have vegetarian options?",
    ai: "Yes, I can share menu options and help you choose based on your preference.",
    followUp: "Menu details can be sent by WhatsApp after the chat.",
    visualLabel: "Menu question preview",
  },
  {
    title: "Event and package enquiries",
    description: "Collects date, guest count, package interest, and budget notes.",
    icon: Tags,
    mode: "Package enquiry",
    customer: "Do you offer birthday dinner packages?",
    ai: "Yes, I can collect the date, number of guests, and package preference so the team can follow up.",
    followUp: "Package enquiry saved with date, guest count, and preference.",
    visualLabel: "Package enquiry preview",
  },
  {
    title: "Missed call callback",
    description: "Calls back missed booking enquiries before they go cold.",
    icon: Phone,
    mode: "AI Voice Agent",
    ai: "Hi, this is the restaurant assistant calling back. I noticed we missed your call. Are you calling about a reservation or menu enquiry?",
    followUp: "Call summary and next step saved for staff review.",
  ...
  },
  {
    ...
    icon: Send,
    mode: "WhatsApp",
    ai: "Your reservation request has been noted. Here are the details and next steps on WhatsApp.",
    followUp: "Guest receives booking details, location, and next steps.",
    visualLabel: "WhatsApp confirmation preview",
  },
  {
    title: "Location and opening hours",
    description: "Answers routine location, closing time, and direction questions.",
    icon: MapPin,
    mode: "FAQ support",
    customer: "What time do you close and where are you located?",
    ai: "We are open until the listed closing time. I can also send the location details by WhatsApp.",
    followUp: "Location and opening hours shared using approved business details.",
    visualLabel: "Location reply preview",
  },
  {
    title: "Staff handoff",
    description: "Routes priority enquiries with the conversation context.",
    icon: UserRoundCheck,
    mode: "Team handoff",
    ai: "I will pass this to the team with your enquiry details so you do not need to repeat everything.",
    followUp: "Staff receives the transcript, summary, and next action.",
    visualLabel: "Staff handoff preview",
  },
];

const hospitalityOutcomeCards: IndustryOutcomeCard[] = [
  {
    value: "Under 5 sec",
  ...
  {
    value: "Less",
    label: "staff time spent on repeated questions",
    icon: MousePointerClick,
  },
];

const hospitalityChannels = ["Website", "WhatsApp", "Instagram", "Facebook"];
...
const hospitalityKnowledgeItems = [
  "Menus",
  "Rooms",
  "Packages",
  "Pricing notes",
...
export function HospitalityFoodIndustryPage() {
    ...
    <section className="relative overflow-hidden pb-16 pt-28 sm:pb-20 sm:pt-32 lg:pb-24">
      ...
      >
        <FadeUp className="min-w-0">
          <Badge>Hospitality & Food</Badge>
          <h1 className="text-h1 mt-6 max-w-4xl font-medium text-foreground">
            Turn guest enquiries into{" "}
            <span className="text-primary">
              bookings <span className="block sm:inline">faster.</span>
            </span>
          </h1>
          <p className="mt-6 max-w-2xl text-lead text-muted-foreground">
            AI voice and chat agents that answer reservation calls, reply to
            WhatsApp enquiries, handle menu and room questions, send follow-ups,
            and help your team capture more bookings.
          </p>
          ...
          <p className="mt-4 max-w-xl text-sm leading-6 text-muted-foreground">
            Built for hotels, restaurants, cafes, resorts, catering teams, and
            food brands that need fast guest response.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Button asChild size="xl" className="w-full sm:w-auto">
              <Link href="/contact">
                See Hospitality Demo <ArrowRight aria-hidden />
              </Link>
            </Button>
    ...
    <section className="py-16 sm:py-20">
      <Container size="wide">
        <FadeUp>
          <SectionHeader
            eyebrow="Use cases"
            title="What your Hospitality AI Agent can handle"
            subtitle="Tap a card to preview how voice, chat, and WhatsApp follow-ups help turn guest enquiries into confirmed bookings."
          />
        </FadeUp>
        <StaggerGrid className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {hospitalityUseCases.map((useCase) => (
            ...
            <div className="p-6 sm:p-8">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <DialogDescription className="mt-3 text-sm leading-6 text-muted-foreground">
                    Preview how voice, chat, and WhatsApp follow-up keep guest
                    conversations moving toward a booking.
                  </DialogDescription>
                </div>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-sm text-muted-foreground">
                  Real GIFs and videos can be added once your hospitality
                  workflow is mapped.
                </p>
                <Button asChild>
                  <Link href="/contact#book">Book a Call</Link>
    ...
    <section className="py-16 sm:py-24">
      <Container size="wide">
        <FadeUp>
          <SectionHeader
            eyebrow="Dashboard"
            title="Your hospitality command centre."
            subtitle="Manage menus, rooms, services, enquiries, reservations, transcripts, and follow-ups from one dashboard."
          />
        </FadeUp>
            ...
            <div className="rounded-2xl border border-border bg-background/45 p-4 sm:p-5">
              <div className="flex flex-col gap-4 border-b border-border pb-5 md:flex-row md:items-center md:justify-between">
                <div>
                  <p className="text-sm font-semibold text-foreground">
                    Kaizen Hospitality Dashboard
                  </p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    Menus, rooms, calls, chats, reservations, and follow-ups in
                    one place.
                  </p>
                </div>
                <div className="flex flex-wrap gap-2">
                  {["Menus", "Rooms", "Calls", "Chats", "Bookings"].map(
                    (item, index) => (
                      <span
                        key={item}
                        className={cn(
              ...
              <div className="mt-5 grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
                <IndustryDashboardPanel
                  icon={ImageIcon}
                  title="Menu / Room / Service Inventory Manager"
                  description="Upload menu items, room images, package details, prices, availability notes, event options, opening hours, and FAQs so the AI can answer accurately."
                >
                  <div className="grid gap-4 lg:grid-cols-[0.86fr_1.14fr]">
                    ...
                    <div className="grid gap-2">
                      {[
                        ["Item or room name", "Deluxe room / set menu"],
                        ["Description", "Approved guest-facing details"],
                        ["Availability", "Weekend and weekday notes"],
                        ["Package details", "Birthday, dinner, event options"],
                        ["FAQ notes", "Parking, dietary, location, opening hours"],
                      ].map(([label, value]) => (
                        <div
                          key={label}
                ...
                <IndustryDashboardPanel
                  ...
                  description="View full AI voice call transcripts, summaries, guest intent, and next action after every call."
                >
                  <div className="rounded-2xl border border-primary/20 bg-primary/10 p-4">
                    ...
                    <div className="mt-3 space-y-2 text-xs text-muted-foreground">
                      <p className="rounded-xl border border-border bg-background/45 p-3">
                        Summary: asked for table availability, shared guest
                        count, requested WhatsApp confirmation.
                      </p>
                      <p className="rounded-xl border border-border bg-background/45 p-3">
                        Transcript preview: Wants a reservation and location
                ...
                <IndustryDashboardPanel
                  ...
                  description="View every guest or customer conversation separately by channel."
                >
                  <div className="flex flex-wrap gap-2">
                    {hospitalityChannels.map((channel, index) => (
                      <span
                        key={channel}
                        className={cn(
                          "rounded-full border px-3 py-1 text-xs font-semibold",
                  ...
                  <div className="mt-4 space-y-2">
                    {[
                      "Asks about table for 4",
                      "Requests vegetarian menu",
                      "Wants room package details",
                    ].map((message) => (
                      <div
                        key={message}
                        className="flex items-center justify-between gap-3 rounded-xl border border-border bg-background/45 px-3 py-2"
                ...
                <IndustryDashboardPanel
                  icon={BarChart3}
                  title="Reservation / Booking Pipeline"
                ...
                <IndustryDashboardPanel
                  icon={Tags}
                  title="Guest Sentiment and Urgency"
                  description="Understand which guests or customers need attention first."
                >
                  <div className="flex flex-wrap gap-2">
                    {hospitalitySentiments.map((label) => (
                      <span
                        key={label}
                ...
                <IndustryDashboardPanel
                  ...
                  description="The business controls what the AI knows and can update menu, room, service, or business information anytime."
                >
                  <div className="grid gap-2 sm:grid-cols-2">
                    {hospitalityKnowledgeItems.map((item) => (
                      <div
                        key={item}
                ...
                <IndustryDashboardPanel
                  ...
                  description="No private business, guest, or customer data belongs to Kaizen AI. The business keeps control of its menus, rooms, guest conversations, transcripts, and dashboard data."
                  className="xl:col-span-2"
                >
                  <div className="flex flex-col gap-3 rounded-2xl border border-primary/25 bg-primary/10 p-4 sm:flex-row sm:items-center">
                    ...
                    <p className="text-sm font-semibold text-foreground">
                      Business-controlled menus, rooms, guest conversations,
                      booking summaries, transcripts, and dashboard data.
                    </p>
                  </div>
                </IndustryDashboardPanel>
              </div>
    ...
    <section className="py-16 sm:py-20">
      <Container size="wide">
        ...
        <StaggerGrid className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {hospitalityOutcomeCards.map((card) => (
        ...
        <p className="mx-auto mt-6 max-w-2xl text-center text-sm leading-6 text-muted-foreground">
          ...
          volume, booking demand, staff process, and implementation.
        </p>
      </Container>
    </section>
  );
    ...
    <section className="py-12 sm:py-18">
      <Container size="wide">
        <FadeUp>
          <SectionHeader
            eyebrow="Mini demo"
            title="From guest call to WhatsApp confirmation."
          />
        </FadeUp>
          ...
          {[
            {
              title: "AI Voice Call",
              preview:
                "Guest calls about a room, table, menu, or event package.",
              icon: Phone,
            },
            {
              title: "AI Booking Support",
              preview:
                "AI collects date, time, number of guests, preference, and contact details.",
              icon: Bot,
            },
            {
              title: "WhatsApp Follow-up",
              preview:
                "Guest receives booking details, location, menu or room information, and next steps by WhatsApp.",
              icon: Send,
            },
          ].map((item, index) => (
        ...
        <FadeUp>
          <Card className="gold-card relative overflow-hidden p-8 text-center shadow-card sm:p-10 lg:p-12">
            ...
            <div className="relative mx-auto max-w-3xl">
              <Badge>Hospitality growth</Badge>
              ...
              <p className="mt-5 text-lead text-muted-foreground">
                Answer calls, reply to messages, confirm enquiries, send
                WhatsApp follow-ups, and help your team focus on guests instead
